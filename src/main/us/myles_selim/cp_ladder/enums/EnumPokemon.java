...
public enum EnumPokemon {
	...
	SQUIRTLE(EnumPokemonStage.BASE, EnumPokemonType.WATER),
	WARTORTLE(EnumPokemonStage.MIDDLE, EnumPokemonType.WATER),
	BLASTOISE(EnumPokemonStage.FINAL, EnumPokemonType.WATER),
	...
	RATTATA(EnumPokemonStage.BASE, EnumPokemonType.NORMAL),
	RATICATE(EnumPokemonStage.FINAL, EnumPokemonType.NORMAL),
	...
	PIKACHU(EnumPokemonStage.BASE, EnumPokemonType.ELECTRIC),
	RAICHU(EnumPokemonStage.FINAL, EnumPokemonType.ELECTRIC),
	SANDSHREW(EnumPokemonStage.BASE, EnumPokemonType.GROUND),
	SANDSLASH(EnumPokemonStage.FINAL, EnumPokemonType.GROUND),
	...
	VULPIX(EnumPokemonStage.BASE, EnumPokemonType.FIRE),
	NINETALES(EnumPokemonStage.FINAL, EnumPokemonType.FIRE),
	...
	DIGLETT(EnumPokemonStage.BASE, EnumPokemonType.GROUND),
	DUGTRIO(EnumPokemonStage.FINAL, EnumPokemonType.GROUND),
	MEOWTH(EnumPokemonStage.BASE, EnumPokemonType.NORMAL),
	PERSIAN(EnumPokemonStage.FINAL, EnumPokemonType.NORMAL),
	...
	GEODUDE(EnumPokemonStage.BASE, EnumPokemonType.ROCK, EnumPokemonType.GROUND),
	GRAVELER(EnumPokemonStage.MIDDLE, EnumPokemonType.ROCK, EnumPokemonType.GROUND),
	GOLEM(EnumPokemonStage.FINAL, EnumPokemonType.ROCK, EnumPokemonType.GROUND),
	...
	GRIMER(EnumPokemonStage.BASE, EnumPokemonType.POISON),
	MUK(EnumPokemonStage.FINAL, EnumPokemonType.POISON),
	...
	EXEGGUTOR(EnumPokemonStage.FINAL, EnumPokemonType.GRASS, EnumPokemonType.PSYCHIC),
	CUBONE(EnumPokemonStage.BASE, EnumPokemonType.GROUND),
	MAROWAK(EnumPokemonStage.FINAL, EnumPokemonType.GROUND),
	...
	EEVEE(EnumPokemonStage.BASE, EnumPokemonType.NORMAL),
	VAPOREON(EnumPokemonStage.FINAL, EnumPokemonType.WATER),
	JOLTEON(EnumPokemonStage.FINAL, EnumPokemonType.ELECTRIC),
	FLAREON(EnumPokemonStage.FINAL, EnumPokemonType.FIRE),
	...
	PICHU(EnumPokemonStage.BABY, EnumPokemonType.ELECTRIC),
	...
	ESPEON(EnumPokemonStage.FINAL, EnumPokemonType.PSYCHIC),
	UMBREON(EnumPokemonStage.FINAL, EnumPokemonType.DARK),
	...
	UNOWN(EnumPokemonStage.BASE, EnumPokemonType.PSYCHIC, EnumGender.UNKNOWN),
	...
	SPINDA(EnumPokemonStage.BASE, EnumPokemonType.NORMAL),
	...
	CASTFORM(EnumPokemonStage.BASE, EnumPokemonType.NORMAL),
	...
	DEOXYS(EnumPokemonStage.MYTHIC, EnumPokemonType.PSYCHIC, EnumGender.UNKNOWN),
	// GEN 4
	...
	BURMY(EnumPokemonStage.BASE, EnumPokemonType.BUG),
	WORMADAM(EnumPokemonStage.FINAL, EnumPokemonType.BUG, EnumPokemonType.GRASS, EnumGender.FEMALE),
	...
	CHERRIM(EnumPokemonStage.FINAL, EnumPokemonType.GRASS), // TODO: Add form if
															// necessary later
	SHELLOS(EnumPokemonStage.BASE, EnumPokemonType.WATER),
	GASTRODON(EnumPokemonStage.FINAL, EnumPokemonType.WATER, EnumPokemonType.GROUND),
	...
	LEAFEON(EnumPokemonStage.FINAL, EnumPokemonType.GRASS),
	GLACEON(EnumPokemonStage.FINAL, EnumPokemonType.ICE),
	...
	ROTOM(EnumPokemonStage.BASE, EnumPokemonType.ELECTRIC, EnumPokemonType.GHOST, EnumGender.UNKNOWN),
	...
	GIRATINA(EnumPokemonStage.LEGEND, EnumPokemonType.GHOST, EnumPokemonType.DRAGON, EnumGender.UNKNOWN),
	...
	ARCEUS(EnumPokemonStage.MYTHIC, EnumPokemonType.NORMAL, EnumGender.UNKNOWN),
	...
	SYLVEON(EnumPokemonStage.FINAL, EnumPokemonType.FAIRY),
